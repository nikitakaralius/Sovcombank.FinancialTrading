...
{
    public record Unverified(UserId Id, FullUserName Username, EmailAddress Email) : UserProfile;

    public record Verified(UserId Id, FullUserName Username, EmailAddress Email) : UserProfile;
